...
class FileImporter:
    ...
    def import_file(self, file_obj, folder):
        ...
        if self.verbosity >= 2:
            print(
                f"file_created #{self.file_created} / image_created #{self.image_created} -- file : {obj} -- created : {created}"
            )
        return obj
    ...
    def get_or_create_folder(self, folder_names):
        ...
        for folder_name in folder_names:
            ...
            if created:
                ...
                if self.verbosity >= 2:
                    print(
                        f"folder_created #{self.folder_created} folder : {current_parent} -- created : {created}"
                    )
